...
function MenuItem({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-[52px] w-full justify-center rounded-[14px] bg-transparent px-2 py-[12px] text-[17px] text-[var(--app-text)] transition hover:bg-white/10"
    >
...
export default function ProfileMenuSheet({
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed left-1/2 top-[96px] z-[25] w-[300px] -translate-x-1/2 rounded-[26px] bg-[var(--app-card)] text-[var(--app-text)] px-6 py-6 shadow-[0_16px_40px_rgba(0,0,0,0.10)]"
